  ...
  mount.innerHTML = `
    <section class="card">
      ...
      <div class="photo-gallery">
        ${profile.photo1?`<img src="${profile.photo1}" alt="Photo 1">`:""}
        ${profile.photo2?`<img src="${profile.photo2}" alt="Photo 2">`:""}
        ${profile.photo3?`<img src="${profile.photo3}" alt="Photo 3">`:""}
      </div>
    </section>
    ...
    <section class="card">
      <h3>✨ Western Zodiac Insight: ${west}</h3>
      <p>${westernMap[west]||""}</p>
    </section>

    <section class="card">
      <h3>🐉 Chinese Zodiac Insight: ${chi}</h3>
      <p>${chineseMap[chi]||""}</p>
    </section>
